...
import { Button, Input, Form, Layout, Alert } from "antd";
    ...
    <Layout>
      ...
      <Content className={styles.content}>
        <div className={styles.shortner}>
          ...
          <Form onFinish = {onFinish} form={form} onFinishFailed={onFinishedFailed}>
            <div className={styles.linkField}>
              <div className={styles.linkFieldInput}>
                ...
                >
                  <Input
                    placeholder="https://my-super-long-link.com/blah-blah-blah-blah-blah-blah-blah-blah"
                    size="large"
                  />
                </Form.Item>
              </div>
          ...
          {["error", "success"].includes(status) && (
            <Alert showIcon message={message} type={status as 'error' | 'success'} />
          )}
        </div>
      </Content>
      <Footer className={styles.footer}>URL Shortner &copy; 2021</Footer>
    </Layout>
  );
}
//xBbAuIFZfGaVrA8K
